"""
PDF Report Generation Service for CyberDefence Platform v3.1

Handles secure PDF generation for security assessment reports.
Includes custom PDF formatting, styling, and multi-page layout.
"""
